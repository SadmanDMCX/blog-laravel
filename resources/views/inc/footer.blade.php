    ...
    <div class="container">
            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >{{$data['settings']->site_name}}</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
                        <p class="heading-text">
                            {!! $data['settings']->about_us !!}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$data['settings']->contact_number}}</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$data['settings']->contact_email}}</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$data['settings']->address}}</a>
                            <p class="sub-title">Shapla Chottor, Motijheel, Dhaka</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                All Copyright &copy; <a href="{{route('dashboard')}}" class="btn btn-xs btn-danger" style="padding: 0 0 20px;">SadmanDMCX</a>
            </div>
        </div>
