...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b1a6d747760e4d8"></script>

<script src="{{ asset('js/toastr.min.js') }}"></script>
<script>
    @if(Session::has('subscribe'))
        toastr.success("{{Session::get('subscribe')}}", "", {timeOut: 1500})
    @endif
</script>
